        ...
        <section className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap gap-4 text-xs text-slate-300">
            <div className="flex flex-col">
              ...
              <span className="font-semibold text-white">{formatSignedValue(signal.bias, 1)}</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[11px] uppercase tracking-wide text-slate-400">Active timeframes</span>
              <span className="font-semibold text-white">{signal.contributions.length}</span>
            </div>
          </div>
        </section>
